...
foreach ($_GET as $key => $value)
{
        ...
        {
            $data = "$key,$value\n";
            file_put_contents($salesdiscounts, $data, FILE_APPEND);
        }
    }
	$salesdiscounts = "salesdiscounts.txt";
	if (file_exists($salesdiscounts)) 
	{
		echo "<strong><p style=\"text-align:center\">Discount(s) added. </strong></p>";
		echo "<div style=\"text-align:center\"><a href=\"currentDiscounts.php\">Return</a></div>";
	}
?>
<footer>

...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
	  ...
	  <p><a href="seeReviews.php">See pendings reviews</a></p>
    </div>
    <div class="col-sm-4">
      <h3>Dis-Manager™</h3>  
        <p><a href="currentDiscounts.php">Manage discounts</a></p>
    </div>
    <div class="col-sm-4">
      <h3>Manage products</h3>
	  <p><a href="manageInventory.php">Manage the current stock of cars</a></p>
    </div>
  </div>
</div>
<p style="text-align:center; margin-top: 10%"><a href="userSetting.php">Go back</a></p>
<br>
<footer>

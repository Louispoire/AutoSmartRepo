...
<h2 style="text-align:center;"> Thank you for shopping at AutoSmart!</h2>
<?php
	echo "<h3 style=\"text-align:center\"> Order sumbitted on ". date("Y/m/d") . "</h3>";
?>
<h3 style="text-align:center; padding-bottom: 4%;"><a href="seestore.php">Continue to shop</a></h3>";
<footer>

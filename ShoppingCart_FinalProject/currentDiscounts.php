...
<!--<h2 style="text-align:center">Current Discounts:</h2>-->
<br>
<div style="text-align:center">
<h3 style="font-family: sans-serif; margin-bottom: 5%;">Dis-Manager™</h3>
<?php
    echo displayDiscounts("salesdiscounts.txt", "discounts");
?>
</div>
<br>
<h3 style="text-align:center"><a href='addDiscounts.php'>Add discounts to store</a></h3>;

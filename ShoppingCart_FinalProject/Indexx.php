...
<div class="container" style="font-family: sans-serif; font-size: 100%;">
  <div class="row">
    <div class="col-sm-4">
      <h3>Safe Checkout</h3>
	  <p>Buy in peace using AutoSmart TRX SSL encryption technology</p>
	  <img style="height: 200px; width: 350px" src="https://www.dreamhost.com/blog/wp-content/uploads/2017/11/online_payment-750x400.jpg" alt="card">
    </div>
    <div class="col-sm-4">
      <h3>Quality Craftmanship</h3>
	  <p>Each car sold in AutoSmart website is entirely made using the best material and craftmanship</p>
      <img style="height: 200px; width: 350px" src="https://www.maloyachts.se/wp-content/uploads/2016/06/02-05_2-1024x516.jpg" alt="crasftmanship">
    </div>
    <div class="col-sm-4">
      <h3>24/7 support</h3>  
	 <p>Do not hesitate to contact our fast customer support. Available 24/7</p>      
     <a href="https://bigassmessage.com/bbc94"><img style="height: 200px; width: 350px" src="https://cdn.discordapp.com/attachments/651100352833126403/708739066157465610/support.jpg" alt="support"></a>
    </div>
  </div>
</div>
<footer>

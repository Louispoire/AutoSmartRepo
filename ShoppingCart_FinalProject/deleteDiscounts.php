...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top" style="margin-bottom: 5%;">
  <div class="container">
     <a class="navbar-brand" href="#">
          <img style="width: 80px; height= 60px;" src="Images\carLogo.png" alt="logo">
        </a>
...
<div>
<h2 style="text-align:center;">Create Discounts:</h2>
</div>
<br>
<?php
$salesdiscounts = "salesdiscounts.txt";
$data;
$data = "";
file_put_contents($salesdiscounts, $data);
if (file_exists($salesdiscounts)) 
{
	echo "<strong><p style=\"text-align:center\">Discount(s) deleted. </strong></p>";
	echo "<div style=\"text-align:center\"><a href=\"admin.php\">Return</a></div>";
}
?>
<footer>
